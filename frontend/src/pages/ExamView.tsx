...
export default function ExamView() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Removed backend API call and student_id field to fix errors

            const { data: submission, error } = await supabase.from('submissions').insert({
                exam_id: id,
                // student_id removed because it doesn't exist in the schema
            ...
            if (submission && Object.keys(answers).length > 0) {
                ...
                if (answersError) {
                    ...
                    // We don't throw here because the main submission succeeded
                }
            }
