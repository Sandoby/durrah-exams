...
export default function PrivacyPolicy() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            <Seo
                title="Privacy Policy – Data Security & Integrity | Durrah"
                description="Read the Durrah Privacy Policy. Learn how we collect, process, and protect data for educators and students in compliance with GDPR and COPPA."
            />
            {/* Header */}
