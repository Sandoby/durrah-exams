...
import { Plus, Edit, Trash2, LogOut, Share2, BarChart3, FileText, Settings, Crown, Menu, X, TrendingUp, Lock, BookOpen, Power } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <main className="max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
                <div className="space-y-8">
                    <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-700 rounded-2xl p-6 sm:p-8 text-white shadow-xl">
                        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
                            <div>
                                ...
                                <p className="text-indigo-100 text-lg">Create, manage, and analyze your exams with ease</p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                                <Link
                                    ...
                                    className="inline-flex items-center justify-center px-6 py-3 border-2 border-white/20 rounded-xl shadow-lg text-sm font-medium text-white bg-white/10 hover:bg-white/20 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-white/50 transition-all duration-200 hover:scale-105"
                                >
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-xl shadow-lg text-sm font-medium text-indigo-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all duration-200 hover:scale-105 transform"
                                >
                    ...
                    {exams.length === 0 ? (
                        <div className="text-center py-16 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                            <div className="max-w-md mx-auto">
                                <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FileText className="h-10 w-10 text-white" />
                                </div>
                                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('dashboard.noExams.title')}</h3>
                                <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">{t('dashboard.noExams.desc')}</p>
                                <div className="space-y-4">
                                    ...
                                    <div className="text-sm text-gray-500 dark:text-gray-400">
                                        <p>💡 {t('dashboard.noExams.hint', 'Start by creating your first exam or exploring the question bank')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ) : (
                        <div className="grid gap-6 sm:gap-8 mb-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                            {exams.map((exam, index) => (
                                <div key={exam.id} data-tour={index === 0 ? "exam-card" : undefined} className="group bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 dark:border-gray-700 overflow-hidden">
                                    <div className="p-6">
                                        <div className="flex justify-between items-start mb-4">
                                            ...
                                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ml-3 ${
                                                ...
                                                <div className={`w-2 h-2 rounded-full mr-2 ${exam.is_active ? 'bg-emerald-500' : 'bg-red-500'}`}></div>
                                        ...
                                        <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mb-4">
                                            ...
                                            {exam.quiz_code && (
                                                <span className="flex items-center gap-1">
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L21 21m-6-6l-6 6m0-6l6 6" />
                                                    </svg>
                                                    {exam.quiz_code}
                                                </span>
                                            )}
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex space-x-1">
                                                <button
                                                    ...
                                                    className="p-2 text-gray-400 hover:text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg transition-all duration-200 group/btn"
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-900/20 rounded-lg transition-all duration-200 group/btn"
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-all duration-200 group/btn"
                                                    title={t('dashboard.actions.results')}
                                                >
                                                    <BarChart3 className="h-5 w-5 group-hover/btn:scale-110 transition-transform" />
                                                </button>
                                                <button
                                                    onClick={() => {
                                                ...
                                                >
                                                    {profile?.subscription_status === 'active' ? (
                                                        <TrendingUp className="h-5 w-5 group-hover/btn:scale-110 transition-transform" />
                                                    ) : (
                                            ...
                                            <div className="flex space-x-1">
                                                <button
                                                    onClick={async () => {
                                                        ...
                                                        try {
                                                            ...
                                                            toast.success(newStatus ? t('dashboard.status.activated', 'Exam activated') : t('dashboard.status.deactivated', 'Exam deactivated'));
                                                        } catch (err) {
                                                            toast.error(t('dashboard.status.updateError', 'Failed to update exam status'));
                                                        }
                                                    }}
                                                    className={`p-2 rounded-lg transition-all duration-200 group/btn ${exam.is_active ? 'text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20' : 'text-emerald-400 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20'}`}
                                                    title={exam.is_active ? t('dashboard.actions.deactivate', 'Deactivate Exam') : t('dashboard.actions.activate', 'Activate Exam')}
                                                >
                                                    <Power className="h-5 w-5 group-hover/btn:scale-110 transition-transform" />
                                                </button>
                                                <Link
                                                    to={`/exam/${exam.id}/edit`}
                                                    className="p-2 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-lg transition-all duration-200 group/btn"
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all duration-200 group/btn"
