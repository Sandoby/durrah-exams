                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <div className="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg p-4 mb-4">
                                <p className="text-gray-900 dark:text-white font-medium">Email: support@durrahtutors.com</p>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 mb-4">
                        ...
                        <section className="mb-8">
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                                ...
                                <p className="text-gray-600 dark:text-gray-300">Email: support@durrahtutors.com</p>
                            </div>
                        </section>
                    </div>
                </div>
