...
export default function PricingPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            <Seo
                title={t('pricing.seo.title', 'Pricing Plans - Affordable Online Exam Platform | Durrah for Tutors')}
                description={t('pricing.seo.description', 'Flexible pricing plans for educators. Start free with 3 exams or upgrade to Professional for unlimited exams, analytics, and anti-cheating features. 14-day free trial available.')}
                keywords="exam platform pricing, online assessment pricing, quiz maker cost, educational software pricing, exam creator subscription, durrah pricing"
