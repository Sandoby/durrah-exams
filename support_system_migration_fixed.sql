-- =====================================================
-- DURRAH SUPPORT SYSTEM DATABASE SCHEMA - FIXED VERSION
-- =====================================================
...
DROP POLICY IF EXISTS "Agents can view all messages" ON ticket_messages;
DROP POLICY IF EXISTS "Users can send messages to their tickets" ON ticket_messages;
DROP POLICY IF EXISTS "Agents can send messages" ON ticket_messages;

DROP POLICY IF EXISTS "Users can view their own chat sessions" ON live_chat_sessions;
DROP POLICY IF EXISTS "Agents can view all chat sessions" ON live_chat_sessions;
DROP POLICY IF EXISTS "Users can create chat sessions" ON live_chat_sessions;
DROP POLICY IF EXISTS "Agents can update chat sessions" ON live_chat_sessions;
...
DROP POLICY IF EXISTS "Agents can view canned responses" ON canned_responses;
DROP POLICY IF EXISTS "Agents can create canned responses" ON canned_responses;
...
-- MIGRATION COMPLETE
-- =====================================================
-- You can now proceed to create your first admin account
