...
CREATE INDEX IF NOT EXISTS idx_classroom_announcements_classroom_id ON public.classroom_announcements(classroom_id);
CREATE INDEX IF NOT EXISTS idx_classroom_announcements_created_at ON public.classroom_announcements(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_announcement_comments_announcement_id ON public.classroom_announcement_comments(announcement_id);
CREATE INDEX IF NOT EXISTS idx_assignments_classroom_id ON public.classroom_assignments(classroom_id);
...
CREATE INDEX IF NOT EXISTS idx_attendance_classroom_id ON public.classroom_attendance(classroom_id);
CREATE INDEX IF NOT EXISTS idx_attendance_student_id ON public.classroom_attendance(student_id);
CREATE INDEX IF NOT EXISTS idx_discussions_classroom_id ON public.classroom_discussions(classroom_id);
...
CREATE INDEX IF NOT EXISTS idx_grade_entries_classroom_id ON public.grade_entries(classroom_id);
