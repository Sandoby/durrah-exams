# ?? **CRITICAL: YOUR FILE NEEDS THESE EXACT CHANGES**

## ? **Problem: The automated scripts didn't work**
The file on GitHub is still the OLD version without the new features.

## ? **Solution: Manual Copy-Paste (5 minutes)**

I'll give you the **exact code snippets** to search and replace.

---

## **Change 1: Fix Import (Line 5)**
...
## **Change 2: Add State Variables (After line 99)**

**FIND THIS** (around line 99):
```typescript
...
## **Change 3: Fix Timer (Line 313)**

**FIND THIS** (around line 313):
```typescript
...
## **Change 4: Add handleSubmitWithCheck (Before handleSubmit, line ~395)**

**RIGHT BEFORE `const handleSubmit = async () => {`** ADD:
...
## **Change 5: Add Progress Bar Variables (Before `if (!exam) return`, line ~640)**
...
## **Change 6: Add Progress Bar UI (In header, after line 766)**
...
## **Change 7: Update Submit Buttons**
...
(There are 2-3 places - do them ALL)

---

## **Change 8: Add Modals (AT THE VERY END, before final `);}`)**

**FIND THE LAST LINES** (around line 1270):
```typescript
                </div>
            </div>
        </div >
...
**CHANGE TO** (add modals BEFORE `</div></div>`):
```typescript
                </div>
...
3. Commit: `git add frontend/src/pages/ExamView.tsx`
4. Commit: `git commit -m "feat: Add progress bar, unanswered warning, and auto-submit countdown"`
5. Push: `git push origin main`

---

**This is the DEFINITIVE version. Make these changes and you're DONE!** ??
